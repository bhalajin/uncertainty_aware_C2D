...
./launch_jobs_sym_20.sh

# LAMBDA_U EXPERIMENTS (noise = 0.9, sym, CIFAR10)
#CUDA_VISIBLE_DEVICES=1 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 500  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run1 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=1 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 500  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run2 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=1 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 550  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run1 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=1 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 550  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run2 --method selfsup --net resnet18
