...
# Results CIFAR-10 80% symetric noise (LAMBDA STUDY, default tau = 0.5)
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 250  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run1 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 250  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run2 --method selfsup --net resnet18

CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 200  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run1 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 200  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run2 --method selfsup --net resnet18

CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 150  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run1 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 150  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run2 --method selfsup --net resnet18

CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 100  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run1 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 100  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run1 --method selfsup --net resnet18
