...
# 3 extra runs to finish 80% with lambda = 400
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 400  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run3 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 400  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run4 --method selfsup --net resnet18
CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.8 --noise_mode sym --lambda_u 400  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.8_weights_run5 --method selfsup --net resnet18

# LAMBDA_U EXPERIMENTS (noise = 0.9, sym, CIFAR10)
#CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 300  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run1 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 300  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run2 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 350  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run1 --method selfsup --net resnet18
#CUDA_VISIBLE_DEVICES=0 python3 main_cifar.py --r 0.9 --noise_mode sym --lambda_u 350  --dataset cifar10 --data_path ./../Datasets/CIFAR10  --experiment-name sym_0.9_weights_run2 --method selfsup --net resnet18
